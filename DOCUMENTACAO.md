# Documentação — Monitor de Formação · Bootcamp Afya
...
Dashboard de monitoramento do Bootcamp Afya + DIO (Automação de Dados com IA). O objetivo é acompanhar semana a semana o progresso dos alunos do grupo de diversidade e identificar quem tem maior probabilidade de se formar, concentrando os esforços de engajamento nas pessoas certas.
...
- **Comparativo com o grupo geral** disponível ao expandir "Comparar com grupo geral"
...
- Informação sobre as monitorias síncronas da PdA
- Link do grupo do WhatsApp da PdA
- Missão da PdA de acelerar pessoas negras e indígenas no mercado tech
...
| Subir novo arquivo no GitHub | ❌ Servidor reinicia, dados são perdidos |

**O que fazer quando o servidor reiniciar:** use o painel de upload para recarregar os arquivos históricos. Selecione todos de uma vez para restaurar o histórico completo.
